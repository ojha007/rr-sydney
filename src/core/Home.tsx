    ...
    <>
      <header className="section page-header">
        <div className="rd-navbar-wrap" style={{ height: "100.453px" }}>
          <nav className="rd-navbar rd-navbar-classic rd-navbar-original rd-navbar-static">
              ...
              <div className="col-lg-6 col-12">
                <div className="block-sm offset-top-45">
                  ...
                  <p className="offset-xl-40 wow fadeInUp" data-wow-delay=".4s">
                    An Australia based AUSTRAC Registered Money transfer Company
                    with, more than thousands corporate and individual clients
                    depends on Registered Remit for their best services to
                    handle their millions of dollars in foreign currency
                    transactions every year in an international Market.
                  </p>
                  <p
          ...
          <div className="container">
            <div className="row">
              <div className="col-xl-7 col-lg-7 col-12">
                <div className="section-name wow fadeInRight">our features</div>
                <h3
                ...
                <p>
                  We are devoted to serve Nepalese all over Nepal from Australia
                  via our simple and systematic remittance facilities. Ensuring
                  to provide fast,cheap and reliable service is our foremost
                  purpose.
                </p>
                <div className="row row-15">
                  ...
                  <div className="col-xl-6 wow fadeInUp" data-wow-delay=".5s">
                    <div className="box-default">
                      ...
                      <p className="box-default-description">
                        Our goal is to make remittance seamless, quick and easy
                      </p>
                  ...
                  <div className="item">
                    ...
                    >
                      <p>
                        ...
                        to all the people to transaction with Registered Remit.
                        It is simply the best remit available
                      </p>
                  ...
                  <div className="item">
                    ...
                    >
                      <p>
                        ...
                        elit. Iusto optio vero vitae, corporis rem, quod id odio
                        asperiores sapiente ratione fugit cumque aliquam dolores
                        ipsam adipisci nisi consectetur neque velit?
                      </p>
                      <div className="item-subsection">
                        <span className="item-subsection-title devider-left">
                          Anthony Parker
